Pod::Spec.new do |s|
  ...
  s.description      = <<-DESC
                       ...
                       DESC
  s.homepage         = "https://github.com/boomibalanB/sample-bcxs"
  s.author           = { "Boomibalan" => "boomibalan.b@syncfusion.com" }
  s.license          = "MIT"
  s.platform         = :ios, "14.0"
  s.source           = { :git => "https://github.com/boomibalanB/sample-bcxs.git", :tag => s.version}
  s.vendored_frameworks = "BoldCXSupportSDK.xcframework"
  s.swift_version    = "5.3"
